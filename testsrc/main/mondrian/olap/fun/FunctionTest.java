...
public class FunctionTest extends FoodMartTestCase {
    ...
    public void testPropertiesNullInsteadOfException() {
        boolean propHandling =
            MondrianProperties.instance().SsasPropertyHandling.get();
        try {
            // default behavior
            MondrianProperties.instance().SsasPropertyHandling.set(
                true);
            TestContext testContext = TestContext.instance().createSubstitutingCube(
                "Sales",
                "<Dimension name=\"Time2\" type=\"TimeDimension\" foreignKey=\"time_id\">\n"
                ...
                + "</Dimension>");
            testContext.assertExprReturns(
                "Month([Time2].[1997].[Q1].Properties(\"The Date\"))", "");
        } finally {
          MondrianProperties.instance().SsasPropertyHandling.set(
              propHandling);
        }
    ...
    public void testIffCrossjoin() {
      assertQueryReturns(
          ...
          + "{}\n"
          + "Axis #1:\n"
          + "{[Store].[USA].[WA].[Bellingham], [Time].[1997].[Q1]}\n"
          + "{[Store].[USA].[WA].[Bellingham], [Time].[1997].[Q2]}\n"
          + "{[Store].[USA].[WA].[Bellingham], [Time].[1997].[Q3]}\n"
          + "{[Store].[USA].[WA].[Bellingham], [Time].[1997].[Q4]}\n"
          + "{[Store].[USA].[WA].[Bremerton], [Time].[1997].[Q1]}\n"
          + "{[Store].[USA].[WA].[Bremerton], [Time].[1997].[Q2]}\n"
          + "{[Store].[USA].[WA].[Bremerton], [Time].[1997].[Q3]}\n"
          + "{[Store].[USA].[WA].[Bremerton], [Time].[1997].[Q4]}\n"
          + "{[Store].[USA].[WA].[Seattle], [Time].[1997].[Q1]}\n"
          + "{[Store].[USA].[WA].[Seattle], [Time].[1997].[Q2]}\n"
          + "{[Store].[USA].[WA].[Seattle], [Time].[1997].[Q3]}\n"
          + "{[Store].[USA].[WA].[Seattle], [Time].[1997].[Q4]}\n"
          + "{[Store].[USA].[WA].[Spokane], [Time].[1997].[Q1]}\n"
          + "{[Store].[USA].[WA].[Spokane], [Time].[1997].[Q2]}\n"
          + "{[Store].[USA].[WA].[Spokane], [Time].[1997].[Q3]}\n"
          + "{[Store].[USA].[WA].[Spokane], [Time].[1997].[Q4]}\n"
          + "{[Store].[USA].[WA].[Tacoma], [Time].[1997].[Q1]}\n"
          + "{[Store].[USA].[WA].[Tacoma], [Time].[1997].[Q2]}\n"
          + "{[Store].[USA].[WA].[Tacoma], [Time].[1997].[Q3]}\n"
          + "{[Store].[USA].[WA].[Tacoma], [Time].[1997].[Q4]}\n"
          + "{[Store].[USA].[WA].[Walla Walla], [Time].[1997].[Q1]}\n"
          + "{[Store].[USA].[WA].[Walla Walla], [Time].[1997].[Q2]}\n"
          + "{[Store].[USA].[WA].[Walla Walla], [Time].[1997].[Q3]}\n"
          + "{[Store].[USA].[WA].[Walla Walla], [Time].[1997].[Q4]}\n"
          + "{[Store].[USA].[WA].[Yakima], [Time].[1997].[Q1]}\n"
          + "{[Store].[USA].[WA].[Yakima], [Time].[1997].[Q2]}\n"
          + "{[Store].[USA].[WA].[Yakima], [Time].[1997].[Q3]}\n"
          + "{[Store].[USA].[WA].[Yakima], [Time].[1997].[Q4]}\n"
          + "Row #0: 518\n"
          + "Row #0: 510\n"
          + "Row #0: 497\n"
          + "Row #0: 712\n"
    ...
    public void testIsError()
    {
        ...
        // Test operation
        assertExprReturns(
            "iif (iserror(Sum([Measures].[Unit Sales])/0)"
            + ", \"is error\", \"not is error\")",
            "is error");
        // Test operations
        assertExprReturns(
            "iif (iserror(Sum([Measures].[Unit Sales])/Sum([Measures].[Unit Sales]) - 1)"
            + ", \"is error\", \"not is error\")",
            "not is error");
    }
...
*/
    ...
    public void testExpectedValueConversion() {
        ...
        assertQueryReturns(
            ...
            + "select {[myset]} on 0, {[Measures].[mymeasure]} "
            + "on 1 from Sales",
            "Axis #0:\n"
            + "{}\n"
            + "Axis #1:\n"
